...
public class DukeShopTest {
	...
	public void 고객_조회테스트(){
		List<Customer> queryForList=queryExecutor.queryForList("product.select2",null,Customer.class);
	...
	public void 주문_조회테스트(){
		List<Orders> queryForList=queryExecutor.queryForList("product.select3",null,Orders.class);
